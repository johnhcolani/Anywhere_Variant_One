import 'package:any_where_app/core/resources/color_manager.dart';
import 'package:any_where_app/core/resources/strings_manager.dart';
import 'package:any_where_app/core/resources/values_manager.dart';
import 'package:any_where_app/features/simpsons_fearture/presentation_layer/screens/detail_screen.dart';
import 'package:flutter/material.dart';
import '../../../../core/resources/assets_manager.dart';
import '../../data_layer/models/simpson_model.dart';

class HomeScreen extends StatefulWidget {
  final List<SimpsonsCharacter> characters;
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<SimpsonsCharacter> filteredCharacters = [];
  bool isLoading = true;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Center(child: Text(AppStrings.simpsonCharacter)),
      ),
      body: Stack(
        children: [
          Container(
